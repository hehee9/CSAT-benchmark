...
Readme에는 **주요 모델의 성적만**을 표기하고 있으니, **전체 성적은 [대시보드](https://hehee9.github.io/CSAT-benchmark/)에서 확인**해주세요.
...
![주요 과목 총점 합 비교](https://hehee9.github.io/CSAT-benchmark/images/전체.png)
...
![총점 최고/최저 조합 비교](https://hehee9.github.io/CSAT-benchmark/images/최고_최저.png)
...
![이미지 있는 문제 득점률](https://hehee9.github.io/CSAT-benchmark/images/이미지O.png)

![이미지 없는 문제 득점률](https://hehee9.github.io/CSAT-benchmark/images/이미지X.png)
...
GPT-5.5 Pro를 제외한 테스트는 실제 API를 통해 진행했으며, 토큰 사용량과 비용을 투명하게 공개하고 있습니다.
...
- 국어·수학·영어·한국사와 탐구 17과목의 시험 매니페스트를 준비 중입니다.
- 사회 탐구: 경제, 동아시아사, 사회문화, 생활과윤리, 세계사, 세계지리, 윤리와사상, 정치와법, 한국지리
- 과학 탐구: 물리1, 물리2, 화학1, 화학2, 생명1, 생명2, 지구1, 지구2
- 문항 파일이 준비되면 매니페스트의 기본인 일반 모드로 실행합니다.

## 평가 방법 상세

OCR을 이용해 우선 문제를 텍스트로 추출한 후, 잘못 옮겨진 부분은 수작업으로 수정했습니다.

쉬움 모드에서는 모든 문제를 필요한 최소한의 정보만을 프롬프트로 각각 입력하였습니다.
쉬움 모드에서 지문 1개에 연계 문제가 있는 구조라면 지문+해당 문제 개별 출제와 같은 방식입니다.
